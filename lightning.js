// Vanilla JS WebGL lightning background adapted from the React version
(function () {
  const VERT = `
  ...
  function initLightningCanvas() {
    ...
    // Set initial size via CSS sizing (100vw x 100vh)
  ...
  const params = { hue: 210, xOffset: 0, speed: 1, intensity: 1, size: 1 };
    ...
    function frame() {
      ...
      gl.uniform1f(uXOffset, params.xOffset);
  ...
  // Public API to configure lightning before init (optional)
  window.LightningBg = {
    init: initLightningCanvas,
  };
})();
