      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          ...
          <div className="lg:col-span-1 flex justify-center">
            <img src="/picture/maxpost.png" alt="Project Management" className="rounded-lg shadow-xl w-64 h-64 md:w-80 md:h-80 object-contain bg-gray-900/40 transition-transform duration-300 ease-out hover:scale-105" />
          </div>
